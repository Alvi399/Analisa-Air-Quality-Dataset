...
ax[0].set_xlabel("Jumlah polutan pm 2.5",fontsize = 35)
...
ax[1].set_xlabel("Jumlah polutan pm 2.5",fontsize = 35)
...
st.subheader("Tingkat plousi pm 10 pada semua wilayah")
fig, ax = plt.subplots(nrows=1,ncols=2,figsize = (35,15))
colors = ["#90CAF9", "#D3D3D3", "#D3D3D3", "#D3D3D3", "#D3D3D3"]
sns.barplot(data=pm10_df.head(5),x="pm10",y="station",palette=colors,ax=ax[0])
ax[0].set_ylabel(None)
ax[0].set_xlabel("Jumlah polutan pm 10",fontsize = 35)
...
ax[1].set_ylabel(None)
ax[1].set_xlabel("Jumlah polutan pm 10",fontsize = 35)
