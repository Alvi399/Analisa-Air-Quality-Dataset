...
ax[0].set_title("wilyah dengan polusi pm 2.5 terbanyak",loc = "center",fontsize = 50)
...
ax[1].set_title("wilyah dengan polusi pm 2.5 tersedikit",loc = "center",fontsize = 50)
ax[1].invert_xaxis()
...
ax[0].set_title("wilyah dengan polusi pm 10 terbanyak",loc = "center",fontsize = 50)
ax[0].tick_params(axis = "x", labelsize = 35) 
ax[0].tick_params(axis = "y", labelsize = 35) 
...
ax[1].set_title("wilyah dengan polusi pm 10 tersedikit",loc = "center",fontsize = 50)
ax[1].invert_xaxis()
ax[1].yaxis.set_label_position("right")
ax[1].yaxis.tick_right()
ax[1].tick_params(axis = "x", labelsize = 35) 
