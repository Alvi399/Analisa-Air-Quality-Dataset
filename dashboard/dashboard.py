...
st.subheader("Tingkat plousim 2.5 pada semua wilayah")
fig, ax = plt.subplots(nrows=1,ncols=2,figsize = (35,15))
colors = ["#90CAF9", "#D3D3D3", "#D3D3D3", "#D3D3D3", "#D3D3D3"]
sns.barplot(data=pm25_df.head(5),x="pm2.5",y="station",palette=colors,ax=ax[0])
ax[0].set_ylabel(None)
ax[0].set_xlabel("Jumlah polutam pm 2.5",fontsize = 35)
ax[0].set_title("wilyah dengan polutan pm 2.5 terbanyak",loc = "center",fontsize = 50)
...
ax[1].set_xlabel("Jumlah polutam pm 2.5",fontsize = 35)
ax[1].set_title("wilyah dengan polutan pm 2.5 tersedikit",loc = "center",fontsize = 50)
ax[1].invert_xaxis()
...
st.subheader("Tingkat plousi 10 pada semua wilayah")
fig, ax = plt.subplots(nrows=1,ncols=2,figsize = (35,15))
colors = ["#90CAF9", "#D3D3D3", "#D3D3D3", "#D3D3D3", "#D3D3D3"]
sns.barplot(data=pm10_df.head(5),x="pm10",y="station",palette=colors,ax=ax[0])
ax[0].set_ylabel(None)
ax[0].set_xlabel("Jumlah polutam pm 10",fontsize = 35)
ax[0].set_title("wilyah dengan polutan pm 10 terbanyak",loc = "center",fontsize = 50)
ax[0].tick_params(axis = "x", labelsize = 35) 
ax[0].tick_params(axis = "y", labelsize = 35) 
sns.barplot(data=pm10_df.sort_values(by = "pm10", ascending = True).head(5),x="pm10",y="station",palette=colors,ax=ax[1])
ax[1].set_ylabel(None)
ax[1].set_xlabel("Jumlah polutam pm 10",fontsize = 35)
ax[1].set_title("wilyah dengan polutan pm 10 tersedikit",loc = "center",fontsize = 50)
ax[1].invert_xaxis()
ax[1].yaxis.set_label_position("right")
ax[1].yaxis.tick_right()
ax[1].tick_params(axis = "x", labelsize = 35) 
